...
/**
 * Class to allow users to input their usernames and submit their scores after they have run out of balls
 *
 * @author Salaar Mir
 */
public class LoseGame {
     ...
     */
    private static final LoseGame SCORE = new LoseGame();
     ...
     */
    public static LoseGame getScore() {
        return SCORE;
    }
     ...
     */
    private final Font MENU_FONT = new Font("Monospaced", TEXT_SIZE);
    ...
    public void showScore() {
        ...
        Text title = new Text("Oh no, you ran out of balls!! Your Score Was : " + Brick.getScore());
