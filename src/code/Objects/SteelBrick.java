...
/**
 * Class to create the steel brick type
 *
 * @author Salaat Mir-modified
 */
public class SteelBrick extends Brick {
    ...
    /**
     * Probability that the steel brick will be impacted when the ball hits it
     */
    ...
    /**
     * Cause the ball to make an impact on the brick if the randomly generated number is less than the STEEL_PROBABILITY
     */
    @Override
    public void impact() {
